                ...
                <div class="col-md-4"> 
                 ...
                 <div class="col-md-4"> 
                  ...
                  <div class="form-group">
                    ...
                    @error('image') <p style="color:green">{{$image}}</p>@enderror
                     <img src="{{asset('storage/avatars/'.$row->image) }}" class="img-thumbnail" width="100" />
                    ...
                    <div class="col-md-4" style="margin-top: 0;">
                        ...
                        <!-- <div class="form-group clearfix"> -->
                          ...
                          <div class="icheck-primary d-inline">
                            <input type="checkbox" name="days[]" id="checkboxPrimary1" class="" value="1" >

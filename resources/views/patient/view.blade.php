               ...
               <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" data-inputmask='"mask": "9999999999"'  data-mask>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                   ...
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="dob" name="dob" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" onchange="getAge();">
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_number" name="id_number" value="" placeholder="id_number">
